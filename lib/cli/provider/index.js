...
module.exports.builder = function(yargs) {
  ...
  return yargs
    ...
    , type: 'number'
    , default: 60000 // 2018-10-18 thinkhy, decrease the waiting time from 60s to 30s, make it fail faster
    })
    .option('cleanup', {
    ...
    .option('connect-gtf-sub', {
      describe: 'GTF agent side ZeroMQ SUB endpoint to connect to.'
    , array: true
    , demand: true
    , default: ['tcp://47.244.5.253:17113']
    })
    .option('connect-gtf-pub', {
      describe: 'GTF agent side ZeroMQ PUB endpoint to connect to.'
    , array: true
    , demand: true
    , default: ['tcp://47.244.5.253:17111']
    })
    ...
    , type: 'string'
    , default: '/etc/saber/packages_whitelist.conf'
    })
...
module.exports.handler = function(argv) {
  ...
  , fork: function(device, ports, whiteList) {
      ...
      .concat(argv.connectGtfPub.reduce(function(all, val) {
        return all.concat(['--gtf-connect-xpub', val])
      }, []))
      .concat(argv.connectGtfSub.reduce(function(all, val) {
        return all.concat(['--gtf-connect-xsub', val])
      }, []))
      ...
      console.log("+++++++ fork device process")
      console.log("+++++++ ", args)
