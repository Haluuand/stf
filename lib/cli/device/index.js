...
module.exports.builder = function(yargs) {
  return yargs
    ...
    .option('gtf-connect-xsub', {
      describe: 'ZeroMQ SUB endpoint to connect to GTF xPub.'
    , array: true
    , demand: true
    , default: ['tcp://47.244.5.253:17113']
    })
    .option('gtf-connect-xpub', {
    describe: 'ZeroMQ PUB endpoint to connect to GTF xSub.'
    , array: true
    , demand: true
...
module.exports.handler = function(argv) {
  ...
  , endpoints: {
    ...
    , gtfSub: argv.gtfConnectXsub
    , gtfPub: argv.gtfConnectXpub
    }
