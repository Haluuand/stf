...
const MIN_SENT_INTERVAL = 100 // Minimal time interval bewteen sending screenshot 2018-03-25 added by thinkhy
...
module.exports = syrup.serial()
  ...
  .define(function(options, adb, minicap, display, screenOptions) {
    ...
    function FrameProducer(config) {
      ...
      this.failCounter = new FailCounter(10, 10000)
    ...
    FrameProducer.prototype._waitForPid = function() {
      ...
      return new Promise(function(resolve) {
        ...
        .timeout(5000) //  2018-11-13 thinkhy timeout 2000 ==> 5000
        .finally(function() {
    ...
    FrameProducer.prototype._stop = function() {
      return this._disconnectService(this.socket).bind(this)
        .timeout(20000) // thinkhy 2018-11-13 for better reliability
        .then(function() {
    ...
    FrameProducer.prototype._stopService = function(output) {
      ...
      function kill(signal) {
        ...
        return Promise.all([
          ...
          .timeout(10000) //  2018-11-13 thinkhy timeout 2000 ==> 10000
      }
    ...
    FrameProducer.prototype._readBanner = function(socket) {
      ...
      return bannerutil.read(socket).timeout(10000)  // 2018-11-13: thinkhy, timeout 2000==>10000
    }
