      ...
      return getPath()
        ...
        .catch(function() {
          ...
          return adb.uninstall(options.serial, resource.pkg)
            ...
            .then(function () {
              log.info('Issue shell command "pm grant jp.co.cyberagent.stf android.permission.DUMP"')
              adb.shell(options.serial, 'pm grant jp.co.cyberagent.stf android.permission.DUMP')
              .then(function(out) {
                return streamutil.readAll(out)
              })
              .timeout(10000)
